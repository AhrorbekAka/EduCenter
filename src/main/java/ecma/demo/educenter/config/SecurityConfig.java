...
//                .permitAll()
                ...
                .antMatchers(HttpMethod.GET, "/api/student").hasAnyAuthority("ADMIN", "DIRECTOR")
                .antMatchers(HttpMethod.GET, "/api/student/search").hasAnyAuthority("ADMIN", "DIRECTOR", "TEACHER")
